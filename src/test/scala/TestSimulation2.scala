...
import main.scala.CloudSimulation2.{createBroker, createDatacenter, createVmList}


class TestSimulation2 extends AssertionsForJUnit {
  ...
  @Test def verifyHostListCreated(): Unit = {
